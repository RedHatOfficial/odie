#!/bin/bash
# This script was borrowed from https://bitbucket.org/denilsonsa/small_scripts/src/78fb99fcb0444b4da31201cc41791b08099919bc/sleep_until_modified.sh?at=default&fileviewer=file-view-default
